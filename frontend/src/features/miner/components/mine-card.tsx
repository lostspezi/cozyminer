...
import type {Mine} from "../types/mine.type";
      ...
      "
        >
            ...
            "
                    ...
                    <div>
                        <h2 className="font-medium">{mine.ore.name} Mine</h2>
          ...
          <span className="text-[10px] uppercase tracking-wide text-stone-500 dark:text-slate-400">
            Lvl
                    ...
                    <div className="text-lg font-semibold">{mine.level}</div>
                </div>
            </div>
            ...
            <div className="space-y-1">
                <div className="flex justify-between text-[11px] text-stone-500 dark:text-slate-400">
                    <span>Progress</span>
                    <span>{mine.progressPercent}%</span>
                </div>

                <div className="h-2 w-full rounded-full bg-stone-200 dark:bg-slate-700 overflow-hidden">
                    <div
                        className={`h-full ${mine.ore.colorClass} transition-all`}
                        style={{width: `${mine.progressPercent}%`}}
                    />
                </div>
            </div>
            ...
            rounded-lg bg-emerald-500 hover:bg-emerald-600
            text-white py-1.5 text-sm transition-colors
          "
                >
                    <GiMineWagon size={18}/>
                    Mine
                ...
                <button
                    className="
            flex-1 flex items-center justify-center gap-2
            rounded-lg border border-stone-300 dark:border-slate-600
          ...
          "
            ...
            {/* FOOTER */}
            <div className="flex justify-between text-[11px] text-stone-500 dark:text-slate-400">
                <span>+{mine.yieldPerAction} / click</span>
                <span>Cost: {mine.upgradeCost}</span>
            </div>
        </div>
    );
}
